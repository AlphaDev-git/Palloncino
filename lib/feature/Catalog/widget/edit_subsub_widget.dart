...
class EditSubSubWidget extends StatefulWidget{
  ...
  State<StatefulWidget> createState() {
    return _EditSubSubWidget();
  }
}


class _EditSubSubWidget extends State<EditSubSubWidget>{
  ...
  void initState() {
    super.initState();
    _name=TextEditingController(text: widget.subsub.subsub);
  }
  @override
                      ...
                      child: ElevatedButton(
                        onPressed: (){
                          if(_name.text!=""){
                            ...
                            if(_image!=null){
                              EditSubSubImage(context, widget.cat,
                                  widget.sub, widget.subsub, _name, _image!);
                            }
                            else{
                              EditSubSub(context,widget.cat,
                                  widget.sub, widget.subsub, _name);
                            }
                          }
                          else{
