...
class CreateSubCatalogWidget extends StatefulWidget{
  Catalog cat;
  CreateSubCatalogWidget(this.cat);
  @override
  State<StatefulWidget> createState() {
    return _CreateSubCatalogWidget();
  }
}


class _CreateSubCatalogWidget extends State<CreateSubCatalogWidget>{
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: (){
                        ...
                        createSubCategory(_name, _image!, context, widget.cat);
                      },
